const questions = [
  ...
  { id: 76, text: 'Chỉ ra câu sai.', options: ['Cường độ dòng điện được đo bằng ampe kế.', 'Để đo cường độ dòng điện, phải mắc nối tiếp ampe kế với mạch điện.', 'Dòng điện chạy qua ampe kế đi vào chốt dương, đi ra chốt âm của ampe kế.', 'Dòng điện chạy qua ampe kế đi vào chốt âm, đi ra chốt dương của ampe kế.'], correct: 'D' },
  ...
  { id: 89, text: 'Công của nguồn điện là', options: ['lượng điện tích mà nguồn điện sinh ra trong 1 s.', 'công của lực lạ làm dịch chuyển điện tích bên trong nguồn.', 'công của dòng điện trong mạch kín sinh ra trong 1 s.', 'công của dòng điện khi dịch chuyển một điện tích dương trong mạch kín.'], correct: 'B' },
  ...
  { id: 92, text: 'Bốn tụ điện mắc thành bộ theo sơ đồ như hình vẽ, \\(C_1 = 1\\mu F; C_2 = C_3 = 3\\mu F\\). Khi nối hai điểm M, N với nguồn điện thì \\(C_1\\) có điện tích \\(q_1 = 6\\mu C\\) và cả bộ tụ có điện tích \\(q = 15,6 \\mu C\\). Hiệu điện thế trên bộ tụ điện là', options: ['1 V', '8V', '6 V', '12 V'], correct: 'B', img: 'https://video.vietjack.com/upload2/quiz_source1/2020/06/p162-1590962394.PNG' },
  { id: 93, text: 'Tụ điện có điện dung \\(2\\mu F\\) có khoảng cách giữa hai bản tụ là 1cm được tích điện với nguồn điện có hiệu điện thế 24V. Ngắt tụ khỏi nguồn và nối hai bản tụ bằng dây dẫn thì năng lượng tụ giải phóng ra là:', options: ['\\(5,76.10^{-4} J\\)', '\\(1,152.10^{-3} J\\)', '\\(2,304.10^{-3} J\\)', '\\(4,217.10^{-3} J\\)'], correct: 'A' },
  ...
  { id: 98, text: 'Một tụ điện có điện dung \\(2000 \\mu F\\) được tích điện đến hiệu điện thế 10 V. Tính năng lượng của tụ điện.', options: ['0,1 J', '1,1 J', '10 J', '20 J'], correct: 'A' },
